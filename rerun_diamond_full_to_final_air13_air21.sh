...
###############################################################################
# Air air13-air21: rerun DIAMOND with full alignment fields, then merge
...
#      under viral_id_pipeline/samples for air13-air21
...
#
# IMPORTANT:
# - Designed for air samples air13 and air21
# - Uses existing outputs from your air viral_id_pipeline
