...
def main():
    ap = argparse.ArgumentParser(description="Create lineage-rich and Sankey-ready outputs from sediment taxonomy results")
    ap.add_argument("--merged-dir", default="/home/panda/workspace/projects/nextflow_metagenomic/eDNA/SED_WF/viral_id_pipeline/merged")
    ...
    ap.add_argument("--out-prefix", default="sed_taxonomy_lineage")
    args = ap.parse_args()
